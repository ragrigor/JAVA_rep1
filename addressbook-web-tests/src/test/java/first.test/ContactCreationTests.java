...
public class ContactCreationTests {
    ...
    public void testContactCreation() {
        ...
        initContactCreation();
        fillContactForm(new ContactData("Test2", "Test2", "2 TestStreet ", "test22@gmail.com", "test33@gmail.com", "456-444", "456-555", "456-666"));
    ...
    private void fillContactForm(ContactData contactData) {
        ...
        wd.findElement(By.name("firstname")).sendKeys(contactData.getName1());
        wd.findElement(By.name("lastname")).click();
        wd.findElement(By.name("lastname")).clear();
        wd.findElement(By.name("lastname")).sendKeys(contactData.getName2());
